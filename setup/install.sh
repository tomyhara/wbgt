...
chmod +x "$SCRIPT_DIR/../src/wbgt_kiosk.py"
chmod +x "$SCRIPT_DIR/../scripts/autostart.sh"
print_success "実行権限を設定しました"

# 動作テスト
print_info "動作テストを実行中..."
if python3 "$SCRIPT_DIR/../src/wbgt_kiosk.py" --demo > /dev/null 2>&1; then
...
echo ""
echo "📱 使用方法："
echo "  デモモード:     cd ../src && python3 wbgt_kiosk.py --demo"
echo "  通常モード:     cd ../src && python3 wbgt_kiosk.py"
echo "  GUI版（実験的）: cd ../src && python3 wbgt_kiosk.py --gui"
echo ""
echo "🗾 地域設定："
...
echo "  crontab使用:"
echo "    crontab -e"
echo "    @reboot cd $SCRIPT_DIR/../src && python3 wbgt_kiosk.py"
echo ""
print_info "まずはデモモードで動作確認してみてください："
echo "cd ../src && python3 wbgt_kiosk.py --demo"
echo "=============================================="